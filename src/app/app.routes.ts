...
export const APP_ROUTES: Routes = [
  ...
  {path: 'profile', pathMatch: 'full', canMatch: [AUTH_USER_CAN_MATCH], component: LayoutComponent, loadChildren: () => import('./components/profile/profile.routes').then(m => m.PROFILE_ROUTES)},
  ];
